    ...
    "paths": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/announcements.indexResponse"
                        }
                    },
                    "403": {
        ...
        "/nodes/{nid}/token": {
            ...
            "post": {
                ...
                "operationId": "Nodes.GenerateToken",
                "parameters": [
                    {
                        "type": "integer",
                        "description": "Node ID",
        ...
        "/nodes/{nid}/users/{username}/traffic": {
            "patch": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "parameters": [
                    {
                        "description": "Traffic Info Object",
                        "name": "traffic",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/nodes.trafficRequest"
                        }
                    },
                    {
                        "type": "integer",
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/nodes.trafficResponse"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
            ...
            "delete": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/services.destroyResponse"
                        }
                    },
                    "403": {
                        "description": "Forbidden",
